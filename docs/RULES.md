...
| CM307 | docstring-semantic-restatement | `threshold=0.5, min_words=3, max_lines=3` | warning |
...
- **CM307 is the semantic second tier behind CM301/CM302** — a vendored
  ...
  unknown-vocabulary clause clears it. The default `threshold` (0.5) favors
